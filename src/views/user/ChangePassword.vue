<template>
  <el-container class="change-password-container">
    <el-card class="change-password-card">
      <h2>更改密碼</h2>
      <el-form :model="form" :rules="rules" ref="resetPasswordForm" hide-required-asterisk label-width="auto">
        ...
        <el-form-item>
          <el-button type="primary" @click="changePassword" class="reset-button">更改密碼</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </el-container>
...
export default {
  ...
  setup() {
    ...
    const changePassword = async () => {
      ...
      try {
        await axios.put(`${import.meta.env.VITE_API_URL}/user/change-password/${username}`, null, {
              params: {
